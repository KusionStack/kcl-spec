...
+ `format(*args, **kwargs) -> str`
  ...
  The format function can accept an unlimited number of arguments, and the positions can be out of order.

```python
>>>"{} {}".format("hello", "world")  # Do not set the specified position, in the default order
'hello world'
